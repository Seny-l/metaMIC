...
def parseargs():
    ...
    parser.add_argument("--pileup",default='pileup.out',help="path to pileup file [pileup file generated by samtools mpileup]")
    parser.add_argument('--output',help='path to working directory')  
    parser.add_argument("--samtools",default='samtools',help='path to samtools')
    parser.add_argument("--contig",default='assemblies',help='path to fasta file of assembled contigs')
    parser.add_argument("--thread",type=int, default=8,help='Maximum number of threads [default: 8]')
